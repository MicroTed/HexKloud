...
#
FFLAGS  = -O1 -g # -fopenmp
#FFLAGS  = -O1 -g -finit-real=snan -ffpe-trap=invalid,zero
...
rk3_main.o: rk3_main.f90 $(OUTPUT_CODE) module_mp_nssl_2mom.o rk3_grid.o \
             initialize.inc.f90 boundaries.inc.f90 $(NCDF_CODE)
	$(FC) -c $(FFLAGS) rk3_main.F90 

rk3_main_ncarg.o: rk3_main.f90 $(OUTPUT_CODE) module_mp_nssl_2mom.o rk3_grid.o \
                  initialize.inc.f90 boundaries.inc.f90 $(NCARG_CODE) $(NCDF_CODE)
